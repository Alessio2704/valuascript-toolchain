...
INSTANTIATE_TEST_SUITE_P(
    ...
    TupleSadPathTest,
    testing::Values(
    TupleSadParam{"tuple_missing_second_value_1", "(1, ", ValuascriptErrorCode::ExpectedRightParenAfterTupleElements},
    TupleSadParam{"tuple_missing_second_value_2", "(a, ", ValuascriptErrorCode::ExpectedRightParenAfterTupleElements},
    ...
    TupleSadParam{"single_element_tuples_not_allowed", "(1, )", ValuascriptErrorCode::SingleElementTuplesNotAllowed},
    TupleSadParam{"missing_operator_1", "(a b)", ValuascriptErrorCode::MissingOperatorInsideGrouping},
    TupleSadParam{"missing_operator_2", "(a, b c)", ValuascriptErrorCode::MissingCommaOrOperatorBetweenExpressions},
