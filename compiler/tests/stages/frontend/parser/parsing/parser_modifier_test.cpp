...
INSTANTIATE_TEST_SUITE_P(
    ...
    ModifierSadPathTest,
    testing::Values(
        ModifierSadParam{"ModifierOnReturn", "func foo() -> void { @export return 1 }", ValuascriptErrorCode::ModifiersOnNonVariableDeclaration},
        ModifierSadParam{"ModifierOnStandaloneExpression", "@export 10 * 5", ValuascriptErrorCode::ModifiersAttachedToInvalidDeclaration},
        ModifierSadParam{"ModifierOnReassignment", "let x = 1\n@export x = 2", ValuascriptErrorCode::ModifiersAttachedToInvalidDeclaration},
        ModifierSadParam{"MissingModifierName", "@ let x = 1", ValuascriptErrorCode::ExpectedModifierName},
        ModifierSadParam{"MissingColonInArg", "@bind(ui \"slider\") let x = 1", ValuascriptErrorCode::MissingColonAfterArgument},
        ModifierSadParam{"MissingArgumentName", "@bind(: \"slider\") let x = 1", ValuascriptErrorCode::MissingArgumentNameInModifier},
        ModifierSadParam{"UnclosedParenthesis", "@bind(ui: \"slider\" let x = 1", ValuascriptErrorCode::UnmatchedParenthesisAfterModifierArgs},
        ModifierSadParam{"DoubleAtSign", "@@export let x = 1", ValuascriptErrorCode::ExpectedModifierName},
        ModifierSadParam{"missing_comma_in_param", "@export(a: 1 b: 2) let x = 1", ValuascriptErrorCode::MissingCommaSeparatorForArgumentsInModifier},
        ModifierSadParam{"missing_operator_1", "@export(a: 1 2) let x = 1", ValuascriptErrorCode::MissingOperator},
        ModifierSadParam{"missing_operator_2", "@export(a: 1 + 2 3) let x = 1", ValuascriptErrorCode::MissingOperator},
        ModifierSadParam{"missing_operator_3", "@export(a: 1 + (2 3)) let x = 1", ValuascriptErrorCode::MissingOperatorInsideGrouping},
        ModifierSadParam{"missing_operator_4", "@export(a: 1 (2 + 3)) let x = 1", ValuascriptErrorCode::MissingOperatorOrArgumentName},
        ModifierSadParam{"missing_operator_5", "@export(a: 1 a() + b()) let x = 1", ValuascriptErrorCode::MissingOperator}
    ),
