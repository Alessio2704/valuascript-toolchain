...
INSTANTIATE_TEST_SUITE_P(
    ...
    ModifierSadPathTest,
    testing::Values(
        ModifierSadParam{"ModifierOnReturn", "func foo() -> void { @export return 1 }", ErrorCode::ModifiersOnNonVariableDeclaration},
        ModifierSadParam{"ModifierOnStandaloneExpression", "@export 10 * 5", ErrorCode::ModifiersAttachedToInvalidDeclaration},
        ModifierSadParam{"ModifierOnReassignment", "let x = 1\n@export x = 2", ErrorCode::ModifiersAttachedToInvalidDeclaration},
        ...
        ModifierSadParam{"MissingArgumentName", "@bind(: \"slider\") let x = 1", ErrorCode::MissingArgumentNameInModifier},
        ModifierSadParam{"UnclosedParenthesis", "@bind(ui: \"slider\" let x = 1", ErrorCode::UnmatchedParenthesisAfterModifierArgs},
        ...
        ModifierSadParam{"missing_operator_3", "@export(a: 1 + (2 3)) let x = 1", ErrorCode::MissingOperatorInsideGrouping},
