...
class SwitchHappyPathTest : public test::AstBaseTest,
...
class SwitchSadPathTest : public test::AstBaseTest,
...
INSTANTIATE_TEST_SUITE_P(
    ...
    SwitchSadPathTest,
    testing::Values(
        SwitchSadParam{"missing_left_paren", "let a = switch res) { case UP -> 1 }", ValuascriptErrorCode::ExpectedLeftParenAfterSwitch},
        SwitchSadParam{"missing_right_paren", "let a = switch (res { case UP -> 1 }",
        ValuascriptErrorCode::ExpectedRightParenAfterSwitchTarget},
        SwitchSadParam{"missing_left_brace", "let a = switch (res) case UP -> 1 }", ValuascriptErrorCode::ExpectedLeftBraceBeforeSwitchBody},
        SwitchSadParam{"missing_right_brace", "let a = switch (res) { case UP -> 1", ValuascriptErrorCode::ExpectedRightBraceAfterSwitchBody},
       ...
       ValuascriptErrorCode::MultipleDefaultCasesInSwitch},
        ...
        SwitchSadParam{"missing_operator_1", "let a = switch (res) { case UP -> 1 2 }", ValuascriptErrorCode::MissingOperatorInSwitchCaseResult},
        SwitchSadParam{"missing_operator_2", "let a = switch (res) { case UP -> 1 (2 + 3) }", ValuascriptErrorCode::MissingOperatorOrArgumentName},
        SwitchSadParam{"missing_operator_3", "let a = switch (res) { case UP -> 1 + a() (2 + 3) }", ValuascriptErrorCode::MissingOperatorOrArgumentName},
        SwitchSadParam{"missing_operator_4", "let a = switch (res) { case UP -> 1 + a() b() }", ValuascriptErrorCode::MissingOperatorInSwitchCaseResult}
