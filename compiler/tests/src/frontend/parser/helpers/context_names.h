...
namespace valuascript::compiler::test::ContextNames
{
    ...
    inline constexpr const char* IdEnumCaseNameMulti1 = "id_enum_case_name_multi_1";
    inline constexpr const char* IdEnumCaseNameMulti2 = "id_enum_case_name_multi_2";
    inline constexpr const char* IdEnumCaseNameMulti3 = "id_enum_case_name_multi_3";
    ...
    inline constexpr const char* IdSwitchCaseLabelMulti1 = "id_switch_case_label_multi_1";
    inline constexpr const char* IdSwitchCaseLabelMulti2 = "id_switch_case_label_multi_2";
    inline constexpr const char* IdSwitchCaseLabelMulti3 = "id_switch_case_label_multi_3";
