...
namespace valuascript::compiler::test {
    ...
    TEST_F(AstBaseTest, ValidatesDeeplyNestedUnaryAndBinaryMath) {
        ...
        auto grouped_add = dynamic_cast<BinaryExpression *>(unwrap_grouping(left_mult->right.get()));
        ...
        // Left of /: Unary NOT (!d)
        auto unary_not = dynamic_cast<UnaryExpression *>(unwrap_grouping(right_div->left.get()));
