...
namespace valuascript::compiler::test {
    ...
    class FunctionHappyPathTest : public AstBaseTest,
    ...
    TEST_P(FunctionHappyPathTest, ParsesSuccessfully) {
        ...
        EXPECT_NO_THROW({
            ...
            }) << "Parser threw an exception on valid function test: " << param.test_name;
    ...
    INSTANTIATE_TEST_SUITE_P(
        ...
        testing::Values(
            ...
            , false},
            FunctionHappyParam{"tuple_param_generic",
            "func bounds(a: (scalar, vector<scalar>, Custom)) -> (scalar, Custom) {}", 1, 1, 0, false},
            FunctionHappyParam{"param_generic", "func test(a: Input<A, B>) -> Result<T, E> {}", 1, 1, 0, false},
            FunctionHappyParam{"tuple_and_struct_param",
            "func bounds(a: (scalar, scalar, Custom), b: Other) -> (scalar, Custom) {}", 2, 1, 0, false},
            FunctionHappyParam{"tuple_and_struct_return",
            "func bounds(a: (scalar, scalar, Custom), b: Other) -> (scalar, Custom), Other {}", 2, 2, 0, false},
            FunctionHappyParam{"dict_literal_return", "func dict() -> dict { return { cagr: 1, yrs: 10 } }", 0, 1, 1,
            false},
